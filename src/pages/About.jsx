...
const About = () => {
  return (
    <div
      className="py-4 md:p-5 flex flex-col items-center justify-center"
      style={{ minHeight: "60vh" }}
    >
      <h1 className="font-mono text-6xl font-medium text-white mb-3">
        About Me
      </h1>
      <p className="font-sans text-2xl text-gray-100 w-5/6 md:w-2/3 text-center md:text-justify">
